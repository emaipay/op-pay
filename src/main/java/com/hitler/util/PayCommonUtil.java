...
import com.hitler.util.WXPayConstants.SignType;

@SuppressWarnings({ "unchecked", "rawtypes" })
public class PayCommonUtil {

	//private static final BaseLogger logger = BaseLogger.getLoggerPro(PayCommonUtil.class);
	...
	public static boolean isTenpaySign(String characterEncoding, SortedMap<Object, Object> packageParams) {
		...
		sb.append("key=" + System.getProperty("wxpay.key"));

		// 算出摘要
		String mysign = EncryptUtil.md5Code(sb.toString()).toLowerCase();
	...
	public static String getSign(Map<String, String> params, String paternerKey) {
		...
		tempResult=MD5Util.MD5Encode(tempResult,"UTF-8");
	...
	public static String createSign(Map<String, String> params) {
		try {
			...
			PayLog.getLogger().info(turboResult);
			return turboResult;
		} catch (Exception e) {
			PayLog.getLogger().error("createSign Exception:"+e.getMessage(), e);
			return null;
		}
	}
	...
	public static String urlEncodeUTF8(String source) {
		...
		try {
			...
			PayLog.getLogger().error("createSign UnsupportedEncodingException:"+e.getMessage(), e);
		}
		return result;
	}
}