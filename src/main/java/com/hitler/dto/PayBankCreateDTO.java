 ...
 *
 */
public class PayBankCreateDTO extends TransientDTO<Integer> {

	/**
	 * 
	 */
	private static final long serialVersionUID = -3323578335563762133L;
	...
	private String last_modifiedDate;
	...
	public String getLast_modifiedDate() {
		return last_modifiedDate;
	}

	public void setLast_modifiedDate(String last_modifiedDate) {
